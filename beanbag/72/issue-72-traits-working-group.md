...
lang-ref: beanbag/72/issue-72-traits-working-group
permalink: /beanbag/72/issue-72-traits-working-group
title: Traits Working Group
description: Issue 72 - Traits Working Group
...
Many papers were published on this subject, a number of them in the [Advances in Legume Systematics 15](<https://link.springer.com/collections/fhbbcjdidd>), as well as others listed in this volume's [Legume Bibliography](/beanbag/72/legume-bibliography-2025.md). A few interesting examples are [Zalko 2025](https://doi.org/10.1007/s40415-024-01044-5), linking vascular anatomy and development in _Swartzia_; [Dörken et al. (2025)](https://doi.org/10.1093/botlinnean/boae065), on the morphology and development of *Jackonia* phyloclades (photosynthetic plane branches); [Huang et al. (2025)](https://doi.org/10.1002/ajb2.70105), unraveling the relationship between leaf traits, phylogeny and environment of Chinese legumes; and [Monteiro et al. (2025)](https://doi.org/10.1093/botlinnean/boaf104) investigation of evolutionary trade-offs in flowers of the Adesmia clade (Dalbergieae, Papilionoideae).
