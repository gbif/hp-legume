...
[![Build Status](https://builds.gbif.org/job/hp-legume/badge/icon)](https://builds.gbif.org/job/hp-legume/lastBuild/console)
...
# GBIF Hosted Portal: hp-legume

This Jekyll website, **[hp-legume](https://hp-legume.gbif.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
