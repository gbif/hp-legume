...
## Key Features
Mostly unarmed trees or shrubs (Australian *Labichea* and *Petalostyles*). Leaves usually imparipinnate with alternate leaflets. Flowers usually arranged in branched, thyrsoid inflorescences. Flowers radially or slightly to strongly bilaterally symmetrical, sometimes papilionate. Sepals usually five, free, equal to sub-equal. Petals five or fewer, free, imbricate, the adaxial petal innermost, all equal to sub-equal. Stamens five or fewer with generally uniform anthers that are basifixed, dehiscing via longitudinal slits that are often reduced to short apical, poricidal slits. Fruits commonly indehiscent drupaceous or samaroid, with generally one to two seeds. 
